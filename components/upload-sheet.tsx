...
import { searchProducts, getSuppliers, createSafetySheet } from '@/lib/actions'
...
export function UploadSheet({ onSuccess }: UploadSheetProps) {
  ...
  const { data: products = [] } = useSWR('all-products', () => searchProducts())
  const { data: suppliers = [] } = useSWR('all-suppliers', () => getSuppliers())
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      await createSafetySheet(formData)
